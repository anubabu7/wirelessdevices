...
urlpatterns = [
    ...
    path('viewProductAdmin/',views.viewProductAdmin),
    ...
    path('viewOfferStaff/',views.viewOfferStaff),
    ...
    path('viewFeedbackUser/',views.viewFeedbackUser),
    path('viewFeedbackStaff/',views.viewFeedbackStaff),
